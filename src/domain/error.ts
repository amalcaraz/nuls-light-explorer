...
export const nulsContractViewError = new ExplorerError('50013', 500, 'Error calling contract view');
export const nulsBroadcastTransactionError = new ExplorerError('50014', 500, 'Error broadcasting a transaction');
